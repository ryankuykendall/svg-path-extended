...
Before writing any code, document the feature:
- Update this `.claude.md` with syntax examples if adding new language features
- Add usage examples to the CLI help text if adding new flags
- Write clear descriptions of expected behavior
