...
export type { AnnotatedOutput, AnnotatedLine, EvaluateWithContextResult, EvaluateWithContextOptions, PathContext, Point, CommandHistoryEntry, LogEntry, LogPart, LayerOutput, CompileResult, LayerStyle, StyleBlockValue, ArrayValue, ObjectValue, PointValue, TextElement, TextChild, PathLayerState, TextLayerState, PathBlockValue, ProjectedPathValue, PathBlockCommand } from './evaluator';
export { isPointValue, isObjectValue, isPathBlockValue, isProjectedPathValue } from './evaluator';
